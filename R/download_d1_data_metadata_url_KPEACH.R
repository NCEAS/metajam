...
#' @param metadata_url (character) An identifier or URL for a Dataone metadata object to download
...
#' @examples
#' \dontrun{
#' new_example <- download_d1_data(
#'                      data_url = "https://cn.dataone.org/cn/v2/resolve/4139539e-94e7-49cc-9c7a-5f879e438b16",
#'                      metadata_url = "https://cn.dataone.org/cn/v2/resolve/10.24431_rw1k45w_2020_7_2_23391",
#'                      path = tempdir())
#' download_d1_data(
...
download_d1_data <- function(data_url, path, dir_name = NULL) {
  ...
  stopifnot(is.character(metadata_url), length(metadata_url) == 1, nchar(metadata_url) > 0)
