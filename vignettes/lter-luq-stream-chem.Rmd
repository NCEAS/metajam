...
test_datasets_listing <- read_csv(system.file("extdata", "[LTER - SEC] Data sets listing - Searched data.csv", 
                                              package = "metajam"))
...
luq_datasets <- map(local_datasets, read_d1_files) %>% 
  set_names(map(luq_datasets, ~.x$summary_metadata$value[.x$summary_metadata$name == "File_Name"]))
```
