...
- Each data set is stored a sub-directory named after the package DOI and the file name
...
- Although the column names were the same in all the data sets, looking at the metadata we discover that the 2 datasets are measuring stream gage height and NH4 concentration in a different way
- We used the metadata to perform the necessary conversions to homogenize the 8 data sets
