...
vignette: >
  %\VignetteIndexEntry{"Use Case - Downloading one dataset from the Arctic Data Center using metajam"}
...
# Suppress check for different YAML title versus vignette title
